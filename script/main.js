...
const animationTimeline = () => {
  ...
  animationTimelineRef = tl;

  tl.to(".container", 0.1, { visibility: "visible" })
    .from(".one", 0.7, { opacity: 0, y: 10 })
    .from(".two", 0.4, { opacity: 0, y: 10 })
    .add("introPause") // ⏸ pause here
    ...
    .from(".wish h5", 0.5, { opacity: 0, y: 10, skewX: "-15deg" })
  ...
  // Auto-resume after 10 seconds if no click
